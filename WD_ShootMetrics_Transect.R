...
Shoots_summ1 <- Shoots %>%
  ...
  summarise(LongestBladeLength.mm=mean(LongestBladeLength.mm),
            LongestBladeWidth.mm=mean(LongestBladeWidth.mm),
            SheathLength.mm=mean(SheathLength.mm),
            EpibiontDryMass.g=mean(EpibiontDryMass.g))
